...
public class ApiUtil {
	 ...
	 *        extracted fields.
	 *
	 * @param endpoint - The API endpoint for fetching the incentive referral
	 *                 summary report.
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response containing the incentive referral summary
	 *         report.
	 */
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response containing the hospital income incentive
	 *         report.
	 */
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response containing employee bill items and
	 *         related data.
	 */
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response containing the fiscal years and their
	 *         details.
	 */
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response includes the HTTP status code and a list
	 *         of stores.
	 */
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response includes the HTTP status code, item
	 ...
	 * @param body     - Optional request body (null in this case).
	 *
	 * @return Response - The API response includes the HTTP status code,
	 *         requisition details, and a list of requisition items.
	 */
	 ...
	 *         message, requisition details such as "CreatedBy", "Status", and a
	 *         list of dispatchers in the "Results" field.
	 */
	 ...
	 *
	 * @return Response - The API response includes the HTTP status code, status
	 *         message, and a list of substore-wise dispatch values in the "Results"
	 *         field.
	 */
